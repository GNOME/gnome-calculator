...
public class Parser
{
    ...
    public static ConstantCategory[] CONSTANT_CATEGORIES = {
        ...
        {_("Electromagnetism"), {
            ...
            {_("Impedance of Vacuum"), "Z₀", mp_set_from_string ("376.730313668")},
            {_("Permeability of Vacuum"), "μ₀", mp_set_from_string ("0.00000125663706212")},
            {_("Permittivity of Vacuum"), "ε₀", mp_set_from_string ("0.0000000000088541878128")},
        }},
        {_("Atomic & Nuclear"), {
            {_("Plank‘s Constant"), "h", mp_set_from_string ("0.000000000000000000000000000000000662607015")},
            {_("Fine-Structure Constant"), "α", mp_set_from_string ("0.0072973525693")},
            {_("Electron Mass"), "mₑ", mp_set_from_string ("0.000000000000000000000000000000910938356")},
            {_("Proton Mass"), "mₚ", mp_set_from_string ("0.000000000000000000000000001672621898")},
        }},
        {_("Thermodynamics"), {
            {_("Boltzmann Constant"), "k", mp_set_from_string ("0.00000000000000000000001380649")},
            {_("Atomic Mass Unit"), "mₐ", mp_set_from_string ("0.0000000000000000000000000016605390666")},
            ...
            {_("Avogadro‘s Number"), "Nₐ", mp_set_from_string ("602214076000000000000000")},
        }},
        {_("Gravitation"), {
