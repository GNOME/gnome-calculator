...
public class UnitManager : Object
{
    ...
    public static UnitManager get_default ()
    {
        ...
        duration_category.add_unit (new Unit ("nanosecond", _("Nanoseconds"), dpgettext2 (null, "unit-format", "%s ns"), "0.000000001x", "1000000000x", dpgettext2 (null, "unit-symbols", "nanosecond,nanoseconds,ns")));
        ...
        pressure_category.add_unit(new Unit ("atm", _("Standard Atmosphere"), dpgettext2 (null, "unit-format", "%s atm"), "101325x", "x/101325", dpgettext2 (null, "unit-symbols", "Standard Atmosphere,Standard atmosphere,standard atmosphere,Atm,atm")));
