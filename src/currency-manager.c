...
static const CurrencyInfo currency_info[] = {
    ...
    {NC_("currency-symbol", "CNY"), "元",   N_("Chinese yuan renminbi")},
    {NC_("currency-symbol", "COP"), "$",    N_("Colombian peso")},
    {NC_("currency-symbol", "CZK"), "Kč",   N_("Czech koruna")},
    ...
    {NC_("currency-symbol", "EUR"), "€",    N_("Euro")},
    ...
    {NC_("currency-symbol", "ILS"), "₪",    N_("Israeli new shekel")},
    {NC_("currency-symbol", "INR"), "₹",    N_("Indian rupee")},
    {NC_("currency-symbol", "IRR"), "﷼",    N_("Iranian rial")},
    {NC_("currency-symbol", "ISK"), "kr",   N_("Icelandic krona")},
    {NC_("currency-symbol", "JPY"), "¥",    N_("Japanese yen")},
    {NC_("currency-symbol", "KRW"), "₩",    N_("South Korean won")},
    {NC_("currency-symbol", "KWD"), "ك.د",  N_("Kuwaiti dinar")},
    {NC_("currency-symbol", "KZT"), "₸",    N_("Kazakhstani tenge")},
    ...
    {NC_("currency-symbol", "LYD"), "د.ل",  N_("Libyan dinar")},
    ...
    {NC_("currency-symbol", "PHP"), "₱",    N_("Philippine peso")},
    {NC_("currency-symbol", "PKR"), "Rs",   N_("Pakistani rupee")},
    {NC_("currency-symbol", "PLN"), "zł",   N_("Polish zloty")},
    {NC_("currency-symbol", "QAR"), "ق.ر",  N_("Qatari riyal")},
    {NC_("currency-symbol", "RON"), "L",    N_("New Romanian leu")},
    {NC_("currency-symbol", "RUB"), "руб.", N_("Russian rouble")},
